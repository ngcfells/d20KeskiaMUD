...
/**
 * Effect: Minor Ability Drain (Tier 1)
 * A persistent drain on a core ability score.
 */
module.exports = {
  config: {
    name: "Minor Ability Drain",
    description: "A persistent drain weakens one of your core abilities.",
    type: "condition",
  ...
  listeners: {
    effectActivated() {
      this.target.say(`<yellow>Your ${this.state.ability} is drained.</yellow>`);
    },
