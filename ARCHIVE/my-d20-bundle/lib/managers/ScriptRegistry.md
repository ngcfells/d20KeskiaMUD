...
class ScriptRegistry {
  ...
  this._register({ id: 'herathian', name: 'Herathian', family: 'aranean', direction: 'ltr', complexity: 'high', magicalAffinity: true });
  this._register({
  id: 'hulian',
  name: 'Hulian Script',
  family: 'hulian_script',
  direction: 'ltr',
  complexity: 'medium',
  magicalAffinity: false,
  notes: 'A bureaucratic script used in Hule; derived from Oltec glyphic roots but simplified for administration.'
});
